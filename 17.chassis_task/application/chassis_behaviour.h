...
#define CHASSIS_AUTOGYRATION_VALUE 4 //自旋状态下角速度大小
...
/**
  ...
  * @retval         none
  */
extern void chassis_no_follow_yaw_control_gyop(fp32 *vx_set, fp32 *vy_set, fp32 *wz_set, chassis_move_t *chassis_move_rc_to_vector);
